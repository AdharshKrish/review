...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="card">
    <div class="card-body">
       <p>The number of M.Tech(DCS) candidate for the project  this academic year(2020-21) is 2 and the  number of M.Tech(IS) candidate is 16. Since the total number of candidates is 18, faculty members are requested to give consent for only one candidate for the M.Tech programme this academic year.</p>
